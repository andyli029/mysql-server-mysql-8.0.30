...
bool tianmu_sysvar_compensation_start;
bool tianmu_sysvar_filterevaluation_speedup;
bool tianmu_sysvar_groupby_speedup;
unsigned int tianmu_sysvar_index_cache_size;
bool tianmu_sysvar_index_search;
bool tianmu_sysvar_enable_rowstore;
bool tianmu_sysvar_insert_delayed;
bool tianmu_sysvar_minmax_speedup;
bool tianmu_sysvar_orderby_speedup;
bool tianmu_sysvar_parallel_filloutput;
bool tianmu_sysvar_parallel_mapjoin;
